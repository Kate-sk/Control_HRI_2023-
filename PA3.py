...
screenPatient = pygame.Surface((600,400)) # was screenHaptic in PA1
screenVR = pygame.Surface((600,400))

body_im = pygame.image.load('body.png')
body_im = pygame.transform.scale(body_im,(600, 400))
...
while run:
    ...
    pygame.draw.line(screenPatient, (0, 0, 0), (haptic.center),(xm))#2*k*(xm-xh)))
    
    ##Render the VR surface
    screenVR.fill(cLightpurple)
    ...
    screenVR.blit(body_im, (0, 0))
    screenVR.blit(scalpel_im,(haptic.topleft[0],haptic.topleft[1]))
